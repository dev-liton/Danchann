/*=====================================================
Template Name   : Cirloxo
Description     : Circus HTML5 Template
Author          : LunarTemp
Version         : 1.0
=======================================================*/
...
(function($) {
    ...
    // flex gallery
    var gpanels = document.querySelectorAll(".team-flex-item");

    function gpanelToggle() {
        document.querySelector(".team-flex-item.active").classList.toggle("active");
        this.classList.toggle("active");
    }
    gpanels.forEach(gpanel => gpanel.addEventListener('mouseover', gpanelToggle));
